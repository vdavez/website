!(function (B, i) {
  ...
  var t,
    ...
    A = 'commento-login-box-sso-button-container',
  ...
  function Je(e, o) {
    ...
    ((i.id = f),
      ...
      De(m, 'profile-button'),
      (n.innerText = e.name),
      (a.innerText = 'Notification Settings'),
      ...
      'undefined' === e.photo
        ? (((t = Ae('div')).style.background = l),
          ...
          De(t, 'avatar'))
        : (Ie((t = Ae('img')), 'src', ae + '/api/commenter/photo?commenterHex=' + e.commenterHex),
          De(t, 'avatar-img')),
      Ne(r, t),
      Ne(r, n),
      Ne(i, r),
  ...
  function $e(e) {
    ...
    ((t.id = ie + e),
      ...
      (l.innerHTML = 'surround text with <pre>**two asterisks**</pre>'),
      (r.innerHTML = '<i>italics</i>'),
      (a.innerHTML = 'surround text with <pre>*asterisks*</pre>'),
  ...
  function Qe(e, o) {
    ...
    return (
      ...
      De(n, 'button-margin'),
      Ie(i, 'placeholder', 'Add a comment'),
      Ie(a, 'type', 'checkbox'),
      Ie(c, 'for', w + e),
      (c.innerText = 'Comment anonymously'),
      (m.innerText = !0 === o ? 'Save Changes' : 'Add Comment'),
      (l.innerHTML = '<b>M &#8595;</b> &nbsp; Markdown'),
      (i.oninput = (function (e) {
        return function () {
          ((e.style.height = ''),
            (e.style.height = Math.min(Math.max(e.scrollHeight, 75), 400) + 'px'));
        };
      })(i)),
      Ue(m, !0 === o ? mo : uo, e),
      Ue(l, $e, e),
  ...
  var Ze = { 'score-desc': 'Upvotes', 'creationdate-desc': 'Newest', 'creationdate-asc': 'Oldest' };
  function eo(e) {
  ...
  function oo(e) {
    ...
    ((o.id = l),
      ...
      ge || fe
        ? le || he
          ? (Ne(t, no('This thread is locked. You cannot add new comments.')), Re(Se(l)))
          : (Ne(t, o), Ne(t, Qe('root')))
  ...
  function to(e) {
    for (
      var o = ['#396ab1', '#da7c30', '#3e9651', '#cc2529', '#922428', '#6b4c9a', '#535154'],
        n = 0,
        t = 0;
      t < e.length;
      t++
  ...
  function ao(L, S) {
    ...
    return (
      e.forEach(function (e) {
        ...
        if (
          ((n =
            'undefined' !== t.link && 'https://undefined' !== t.link && '' !== t.link
              ? Ae('a')
              : Ae('div')),
          (i.id = I + e.commentHex),
          (l.id = q + e.commentHex),
                  ...
                  : n < 864e5
                    ...
                    : n < 2592e6
                      ...
                      : n < 94608e7
                        ...
                        : Math.round(n / 94608e7) + ' years ago';
          })(M, e.creationDate)),
          ...
          De(x, 'option-remove'),
          De(b, 'option-button'),
          xe === e.commentHex ? De(b, 'option-unsticky') : De(b, 'option-sticky'),
          le && (0 < e.direction ? De(f, 'upvoted') : e.direction < 0 && De(h, 'downvoted')),
        ...
        if (
          (Ne(a, m), Ne(a, c), Le || Ne(r, s), Ne(r, o), Ne(r, n), Ne(r, a), Ne(l, d), Ne(y, l), Le)
        ) {
          Ne(y, s);
          var C = Ae('div');
  ...
  function mo(i) {
    ...
    if ('' !== r) {
      Ee(e, 'red-border');
      var o = { commenterToken: Ye(), commentHex: i, markdown: r };
  ...
  function vo(o) {
    var e = { isLocked: ge, stickyCommentHex: xe },
      n = { commenterToken: Ye(), domain: parent.location.host, path: me, attributes: e };
  ...
  ((B.commentApprove = function (i) {
    var e = { commenterToken: Ye(), commentHex: i };
    ...
    (B.commentDelete = function (o) {
      if (confirm('Are you sure you want to delete this comment?')) {
        var e = { commenterToken: Ye(), commentHex: o };
    ...
    (B.vote = function (e) {
      var o = e[0],
        ...
        r = Se(G + o),
        a = Se(_ + o),
        c = { commenterToken: Ye(), commentHex: o, direction: t },
        m = co(i, r, o, t);
      ((i = m[0]),
        (r = m[1]),
        Ee(i, 'upvoted'),
        ...
        (a.innerText = io(parseInt(a.innerText.replace(/[^\d-.]/g, '')) + t - n)),
      ...
      !(function (e, o) {
        ...
        if (o.success) {
          (Ge(),
            ...
            (i.location = re + '/api/oauth/' + n + '/redirect?commenterToken=' + o.commenterToken));
    ...
    (B.popupRender = function (n) {
      ...
      ((o.id = H),
        ...
        (c.innerText = 'Proceed with social login'),
        ...
        Ie(v, 'name', 'email'),
        Ie(v, 'placeholder', 'Email address'),
        Ie(v, 'type', 'text'));
      var y = 0;
      if (
    ...
    (B.signup = function (o) {
      var n = Se(L),
        ...
        t = Se(v),
        i = Se(u),
        r = { email: n.value, name: e.value, website: t.value, password: i.value };
      ...
      (Re(Se(S)),
        ...
        (i =
          'signup' === ke
            ...
            : ((o = ['password']), (n = [u]), (t = ['password']), ['Password'])),
        (a.innerText =
          'signup' === ke
  ...
  var fo = !(B.main = function (e) {
    if (null !== (ce = Se(c))) {
      ...
      (Xe(ae + '/css/commento.css', 'window.commento.loadCssOverride()'),
        Ve(function () {
          !(function (o) {
            var e = { commenterToken: Ye(), domain: parent.location.host, path: me };
                  ...
                  (function () {
                    for (
                      ...
                      Ie(
                        e[o],
                        'style',
                        'max-width: ' + (e[o].getBoundingClientRect().width + 20) + 'px;'
                      );
                  })(),
                  je(e));
              }));
